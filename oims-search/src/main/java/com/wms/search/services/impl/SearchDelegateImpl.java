package com.wms.search.services.impl;
...
import com.wms.search.services.IndexKeywordRequest;
import com.wms.search.services.SearchRequest;
import com.wms.search.services.SearchResponse;
import com.wms.search.services.field.BooleanField;
import com.wms.search.services.field.DateField;
import com.wms.search.services.field.DoubleField;
import com.wms.search.services.field.Field;
import com.wms.search.services.field.IntegerField;
import com.wms.search.services.field.ListField;
import com.wms.search.services.field.LongField;
import com.wms.search.services.field.StringField;
...
public class SearchDelegateImpl implements SearchDelegate {
	...
	/* (non-Javadoc)
	 * @see com.`ch.services.impl.SearchService#indexExist(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#createIndice(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#index(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#delete(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#bulkDeleteIndex(java.util.Collection, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#bulkIndexKeywords(java.util.Collection, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#getObject(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public com.wms.search.services.GetResponse getObject(String collection, String object, String id) throws Exception {
		...
		com.wms.search.services.GetResponse r = null;
		if(response!=null) {
			
			r = new com.wms.search.services.GetResponse(response);
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#search(com.wms.search.services.SearchRequest)
	 */
	@Override
...
/*	        XContentFilterBuilder queryFilter = FilterBuilders.matchAllFilter(); 
			...
			List<com.wms.search.services.SearchHit> hits = new ArrayList<com.wms.search.services.SearchHit>();
	        @SuppressWarnings("rawtypes")
	        ...
	        for (SearchHit sd : docs) {
	          ...
	          // instead of doc.getSource()
	        	...
	        	com.wms.search.services.SearchHit hit = new com.wms.search.services.SearchHit(sd);
	        	hits.add(hit);
	        	ids.add(sd.getId());
	        ...
	        if(facets!=null) {
	        	Map<String,com.wms.search.services.Facet> facetsMap = new HashMap<String,com.wms.search.services.Facet>();
	        	for (Facet facet : facets.facets()) {
	        		 
	        	     if (facet instanceof TermsFacet) {
	        	         TermsFacet ff = (TermsFacet) facet;
	        	         com.wms.search.services.Facet f = new com.wms.search.services.Facet();
	        	         f.setName(ff.getName());
	        	         List<com.wms.search.services.Entry> entries = new ArrayList<com.wms.search.services.Entry>();
	        	         for(Object o : ff) {
	        	        	 com.wms.search.services.Entry entry = new com.wms.search.services.Entry();
	        	        	 Entry e = (Entry)o;
	...
	/* (non-Javadoc)
	 * @see com.wms.search.services.impl.SearchService#searchAutocomplete(java.lang.String, java.lang.String, int)
	 */
	@Override
