...
import com.wms.search.utils.FileUtil;
import com.wms.search.utils.IndexConfiguration;
...
public class ObjectIndexerImpl implements IndexWorker {
	...
	public void execute(SearchClient client, String json, String collection, String object, String id, ExecutionContext context)
		...
		try {
			...
			com.wms.search.services.GetResponse r = searchDelegate.getObject(collection, object, id);
			if(r!=null) {
