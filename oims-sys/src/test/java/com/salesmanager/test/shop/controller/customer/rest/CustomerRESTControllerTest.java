...
import com.wms.web.entity.customer.Customer;
...
public class CustomerRESTControllerTest {
	...
	public void postCustomerOptionValue() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/services/private/DEFAULT/customer/optionValue", entity, PersistableCustomerOptionValue.class);
	...
	public void postCustomerOption() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/services/private/DEFAULT/customer/option", entity, PersistableCustomerOption.class);
	...
	public void getCustomers() throws Exception {
		...
		ResponseEntity<ReadableCustomer[]> response = restTemplate.exchange("http://localhost:8080/oims-sys/services/private/DEFAULT/customer", HttpMethod.GET, httpEntity, ReadableCustomer[].class);
	...
	public void postCustomer() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/services/private/DEFAULT/customer", entity, PersistableCustomer.class);
	...
	public void deleteCustomer() throws Exception {
		...
		restTemplate.exchange("http://localhost:8080/oims-sys/services/private/DEFAULT/customer/"+testCustmerID, HttpMethod.DELETE, httpEntity, Customer.class);
