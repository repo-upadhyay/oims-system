...
import com.wms.web.entity.catalog.category.Category;
...
public class CategoryManagementAPITest {
	...
	public void getCategory() throws Exception {
		...
		ResponseEntity<ReadableCategory> response = restTemplate.exchange("http://localhost:8080/oims-sys/services/public/DEFAULT/category/100?lang=en", HttpMethod.GET, httpEntity, ReadableCategory.class);
	...
	public void postCategory() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/services/private/DEFAULT/category", entity, PersistableCategory.class);
	...
	public void deleteCategory() throws Exception {
		...
		restTemplate.exchange("http://localhost:8080/oims-sys/services/DEFAULT/category/100", HttpMethod.DELETE, httpEntity, Category.class);
