...
import com.wms.web.entity.shop.ContactForm;
...
public class ContactAPITest {
	...
	public void contactUs() throws Exception {
		...
		ResponseEntity<AjaxResponse> response = restTemplate.exchange("http://localhost:8080/oims-sys/services/public/DEFAULT/contact", HttpMethod.POST, httpEntity, AjaxResponse.class);
