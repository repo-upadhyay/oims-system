...
import com.wms.core.business.catalog.product.model.attribute.ProductOptionType;
...
import com.wms.web.entity.catalog.product.attribute.ProductOptionValueDescription;
...
/*		{
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/shop/services/private/manufacturer/DEFAULT", entity, PersistableManufacturer.class);
	...
	public void createProductReview() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/shop/services/private/product/review/DEFAULT", entity, PersistableProductReview.class);
	...
	public void createOptionValue() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/shop/services/private/product/optionValue/DEFAULT", entity, PersistableProductOptionValue.class);
	...
	public void createOption() throws Exception {
		...
		ResponseEntity response = restTemplate.postForEntity("http://localhost:8080/oims-sys/shop/services/private/product/option/DEFAULT", entity, PersistableProductOption.class);
	...
	public void getProducts() throws Exception {
		...
		ResponseEntity<ReadableProduct[]> response = restTemplate.exchange("http://localhost:8080/oims-sys/shop/services/rest/products/DEFAULT/en/"+testCategoryID, HttpMethod.GET, httpEntity, ReadableProduct[].class);
	...
	public void deleteProduct() throws Exception {
		...
		restTemplate.exchange("http://localhost:8080/oims-sys/shop/services/rest/products/DEFAULT/en/"+testCategoryID+"/"+testProductID, HttpMethod.DELETE, httpEntity, ReadableProduct.class);
