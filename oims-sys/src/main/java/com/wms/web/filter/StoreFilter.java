...
import com.wms.web.entity.shop.BreadcrumbItem;
import com.wms.web.entity.shop.BreadcrumbItemType;
import com.wms.web.entity.shop.PageInformation;
import com.wms.web.utils.GeoLocationUtils;
import com.wms.web.utils.LabelUtils;
import com.wms.web.utils.LanguageUtils;
	   ...
	   public boolean preHandle(
			...
			try {
				...
				if(!StringUtils.isBlank(storeCode)) {
					...
					}else{ // when url oims-sys/shop is being loaded for first time store is null
						store = setMerchantStoreInSession(request, storeCode);
					}
				}
				...
				if(anonymousCustomer==null) {
					...
					try {
						...
						com.wms.core.business.common.model.Address geoAddress = customerService.getCustomerAddress(store, ipAddress);
						if(geoAddress!=null) {
							address = new Address();
