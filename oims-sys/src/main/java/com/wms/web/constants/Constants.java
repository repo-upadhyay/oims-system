...
public class Constants {
	...
	public static final String RECAPATCHA_PUBLIC_KEY="oims.recapatcha_public_key";
    public static final String RECAPATCHA_PRIVATE_KEY="oims.recapatcha_private_key";
