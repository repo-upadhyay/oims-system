...
import com.wms.core.business.system.service.SystemConfigurationService;
...
import com.wms.core.constants.SystemConstants;
import com.wms.core.utils.CoreConfiguration;
import com.wms.web.admin.security.WebUserServices;
import com.wms.web.constants.ApplicationConstants;
import com.wms.web.utils.AppConfiguration;
...
public class InitializationLoader {
	...
	@Autowired
	private com.wms.web.init.data.InitData initData;
	...
	public void init() {
		...
		try {
			...
			if (initializationDatabase.isEmpty()) {
				LOGGER.info(String.format("%s : oims database is empty, populate it....", "oims-sys"));
		
				 initializationDatabase.populate("oims-sys");
