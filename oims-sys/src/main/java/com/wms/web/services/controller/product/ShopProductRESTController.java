package com.wms.web.services.controller.product;
...
import com.wms.web.entity.catalog.product.PersistableProduct;
import com.wms.web.entity.catalog.product.PersistableProductReview;
import com.wms.web.entity.catalog.product.ReadableProduct;
import com.wms.web.entity.catalog.product.ReadableProductList;
import com.wms.web.entity.catalog.product.attribute.PersistableProductOption;
import com.wms.web.entity.catalog.product.attribute.PersistableProductOptionValue;
import com.wms.web.populator.catalog.PersistableProductOptionPopulator;
import com.wms.web.populator.catalog.PersistableProductOptionValuePopulator;
import com.wms.web.populator.catalog.PersistableProductPopulator;
import com.wms.web.populator.catalog.PersistableProductReviewPopulator;
import com.wms.web.populator.catalog.ReadableProductPopulator;
import com.wms.web.populator.manufacturer.PersistableManufacturerPopulator;
import com.wms.web.shop.model.filter.QueryFilter;
import com.wms.web.shop.model.filter.QueryFilterType;
...
public class ShopProductRESTController {
	...
	public PersistableManufacturer createManufacturer(@PathVariable final String store, @Valid @RequestBody PersistableManufacturer manufacturer, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.catalog.product.model.manufacturer.Manufacturer manuf = new com.wms.core.business.catalog.product.model.manufacturer.Manufacturer();
	...
	public PersistableProductOptionValue createProductOptionValue(@PathVariable final String store, @Valid @RequestBody PersistableProductOptionValue optionValue, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.catalog.product.model.attribute.ProductOptionValue optValue = new com.wms.core.business.catalog.product.model.attribute.ProductOptionValue();
	...
	public PersistableProductOption createProductOption(@PathVariable final String store, @Valid @RequestBody PersistableProductOption option, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.catalog.product.model.attribute.ProductOption opt = new com.wms.core.business.catalog.product.model.attribute.ProductOption();
	...
	public PersistableProductReview createProductReview(@PathVariable final String store, @Valid @RequestBody PersistableProductReview review, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.catalog.product.model.review.ProductReview rev = new com.wms.core.business.catalog.product.model.review.ProductReview();
...
/*		Map<String,Language> langs = languageService.getLanguagesMap();
	...
	private ReadableProductList getProducts(final int start, final int max, final String store, final String language, final String category, final List<QueryFilter> filters, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.catalog.product.model.ProductList products = productService.listByStore(merchantStore, lang, productCriteria);
