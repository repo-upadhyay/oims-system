package com.wms.web.services.controller.customer;
...
import com.wms.web.constants.EmailConstants;
...
import com.wms.web.populator.customer.PersistableCustomerOptionPopulator;
import com.wms.web.populator.customer.PersistableCustomerOptionValuePopulator;
import com.wms.web.populator.customer.ReadableCustomerPopulator;
import com.wms.web.services.controller.category.ShoppingCategoryRESTController;
import com.wms.web.utils.EmailTemplatesUtils;
import com.wms.web.utils.EmailUtils;
import com.wms.web.utils.FilePathUtils;
...
public class CustomerRESTController {
	...
	public ReadableCustomer getCustomer(@PathVariable final String store, @PathVariable Long id, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.wms.web.entity.customer.Customer customerProxy;
		if(customer == null){
	...
	public PersistableCustomerOptionValue createCustomerOptionValue(@PathVariable final String store, @Valid @RequestBody PersistableCustomerOptionValue optionValue, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.customer.model.attribute.CustomerOptionValue optValue = new com.wms.core.business.customer.model.attribute.CustomerOptionValue();
	...
	public PersistableCustomerOption createCustomerOption(@PathVariable final String store, @Valid @RequestBody PersistableCustomerOption option, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.wms.core.business.customer.model.attribute.CustomerOption opt = new com.wms.core.business.customer.model.attribute.CustomerOption();
