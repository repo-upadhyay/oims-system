...
import com.wms.web.shop.model.paging.PaginationData;
...
public abstract class AbstractController {
    ...
    protected <T> T getSessionAttribute(final String key, HttpServletRequest request) {
	          return (T) com.wms.web.utils.SessionUtil.getSessionAttribute(key, request);

	}
    
    protected void setSessionAttribute(final String key, final Object value, HttpServletRequest request) {
    	com.wms.web.utils.SessionUtil.setSessionAttribute(key, value, request);
	}
    
    
    protected void removeAttribute(final String key, HttpServletRequest request) {
    	com.wms.web.utils.SessionUtil.removeSessionAttribute(key, request);
	}
