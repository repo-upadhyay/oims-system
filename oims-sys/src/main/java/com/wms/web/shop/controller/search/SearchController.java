package com.wms.web.shop.controller.search;
...
import com.wms.core.business.search.service.SearchService;
import com.wms.web.constants.Constants;
import com.wms.web.entity.catalog.SearchProductList;
...
import com.wms.web.shop.model.search.AutoCompleteRequest;
		...
		try {
			...
			if(!CollectionUtils.isEmpty(entries)) {
				...
				for(Product product : productList.getProducts()) {
					...
					//com.wms.web.entity.catalog.Product p = catalogUtils.buildProxyProduct(product,merchantStore,LocaleUtils.getLocale(l));
			...
			if(facets!=null) {
				...
				if(categoriesFacets!=null) {
					...
					for(Category category : categories) {
						//com.wms.web.entity.catalog.Category categoryProxy = catalogUtils.buildProxyCategory(category, merchantStore, LocaleUtils.getLocale(l));
