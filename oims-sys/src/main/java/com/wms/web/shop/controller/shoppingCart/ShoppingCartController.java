package com.wms.web.shop.controller.shoppingCart;
 ...
 * </form>
 *
 * The javascript function creates com.wms.web.entity.shoppingcart.ShoppingCartItem and ShoppingCartAttribute based on user selection
...
public class ShoppingCartController extends AbstractController {
	...
	ShoppingCartData addShoppingCartItem(@RequestBody final ShoppingCartItem item, final HttpServletRequest request, final HttpServletResponse response, final Locale locale) throws Exception {
		...
		if(customer != null) {
			com.wms.core.business.shoppingcart.model.ShoppingCart customerCart = shoppingCartService.getByCustomer(customer);
		...
		//calculate the price of each item by using ProductPriceUtils in oims-core
