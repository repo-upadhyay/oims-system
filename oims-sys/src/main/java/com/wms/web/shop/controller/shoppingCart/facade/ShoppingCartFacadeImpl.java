 ...
 *
 */
package com.wms.web.shop.controller.shoppingCart.facade;
...
import com.wms.core.business.shoppingcart.service.ShoppingCartCalculationService;
...
import com.wms.web.entity.order.CartModificationException;
...
import com.wms.web.populator.shoppingCart.ShoppingCartDataPopulator;
    ...
    implements ShoppingCartFacade
{
        ...
        throws Exception
    {
        ...
        com.wms.core.business.shoppingcart.model.ShoppingCartItem shoppingCartItem =
        ...
        if(CollectionUtils.isEmpty(item.getShoppingCartAttributes())) {//increment quantity
        	...
        	Set<com.wms.core.business.shoppingcart.model.ShoppingCartItem> cartModelItems = cartModel.getLineItems();
        	for(com.wms.core.business.shoppingcart.model.ShoppingCartItem cartItem : cartModelItems) {
    ...
    private com.wms.core.business.shoppingcart.model.ShoppingCartItem createCartItem( final ShoppingCart cartModel,
    ...
    private com.wms.core.business.shoppingcart.model.ShoppingCartItem getEntryToUpdate( final long entryId,
                                                                                                 final ShoppingCart cartModel )
    {
        if ( CollectionUtils.isNotEmpty( cartModel.getLineItems() ) )
        {
            for ( com.wms.core.business.shoppingcart.model.ShoppingCartItem shoppingCartItem : cartModel.getLineItems() )
            {
        ...
        throws Exception
    {
        if ( StringUtils.isNotBlank( cartId ) )
        {
            ...
            if ( cartModel != null )
            {
                if ( CollectionUtils.isNotEmpty( cartModel.getLineItems() ) )
                {
                    Set<com.wms.core.business.shoppingcart.model.ShoppingCartItem> shoppingCartItemSet =
        ...
        throws Exception
    {
        ...
        if ( StringUtils.isNotBlank( cartId ) )
        {
            ...
            if ( cartModel != null )
            {
                com.wms.core.business.shoppingcart.model.ShoppingCartItem entryToUpdate =
    ...
    public ShoppingCartData updateCartItems( final List<ShoppingCartItem> shoppingCartItems, final MerchantStore store, final Language language )
            throws Exception
        {
    		...
    		ShoppingCart cartModel = null;
    		Set<com.wms.core.business.shoppingcart.model.ShoppingCartItem> cartItems = new HashSet<com.wms.core.business.shoppingcart.model.ShoppingCartItem>();
