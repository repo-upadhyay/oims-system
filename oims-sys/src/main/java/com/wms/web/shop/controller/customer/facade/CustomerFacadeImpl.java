 ...
 *
 */
package com.wms.web.shop.controller.customer.facade;
...
import com.wms.core.business.customer.exception.CustomerNotFoundException;
...
import com.wms.core.business.user.service.GroupService;
import com.wms.core.business.user.service.PermissionService;
...
import com.wms.web.populator.customer.CustomerBillingAddressPopulator;
import com.wms.web.populator.customer.CustomerDeliveryAddressPopulator;
import com.wms.web.populator.customer.CustomerEntityPopulator;
import com.wms.web.populator.customer.CustomerPopulator;
import com.wms.web.populator.customer.PersistableCustomerBillingAddressPopulator;
import com.wms.web.populator.customer.PersistableCustomerShippingAddressPopulator;
...
public class CustomerFacadeImpl implements CustomerFacade
{
    ...
    /* (non-Javadoc)
    *  @see com.wms.web.shop.controller.customer.facade#mergeCart(final Customer customerModel, final String sessionShoppingCartId ,final MerchantStore store,final Language language)
    */
    @Override
