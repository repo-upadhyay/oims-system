	...
	public ProductOptionValue populate(PersistableProductOptionValue source,
		...
		try {
			...
			if(!CollectionUtils.isEmpty(source.getDescriptions())) {
				Set<com.wms.core.business.catalog.product.model.attribute.ProductOptionValueDescription> descriptions = new HashSet<com.wms.core.business.catalog.product.model.attribute.ProductOptionValueDescription>();
				for(ProductOptionValueDescription desc  : source.getDescriptions()) {
					com.wms.core.business.catalog.product.model.attribute.ProductOptionValueDescription description = new com.wms.core.business.catalog.product.model.attribute.ProductOptionValueDescription();
