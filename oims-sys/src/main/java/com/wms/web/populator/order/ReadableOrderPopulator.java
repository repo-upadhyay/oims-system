...
import com.wms.core.business.order.model.OrderTotalType;
...
public class ReadableOrderPopulator extends
	...
	public ReadableOrder populate(Order source, ReadableOrder target,
		...
		com.wms.web.entity.order.OrderTotal taxTotal = null;
		com.wms.web.entity.order.OrderTotal shippingTotal = null;
...
;			address.setCompany(source.getDelivery().getCompany());
		...
		List<com.wms.web.entity.order.OrderTotal> totals = new ArrayList<com.wms.web.entity.order.OrderTotal>();
		for(OrderTotal t : source.getOrderTotal()) {
			...
			if(t.getOrderTotalType().name().equals(OrderTotalType.TOTAL.name())) {
				com.wms.web.entity.order.OrderTotal totalTotal = createTotal(t);
				...
				com.wms.web.entity.order.OrderTotal subTotal = createTotal(t);
				totals.add(subTotal);
				
			}
			else {
				com.wms.web.entity.order.OrderTotal otherTotal = createTotal(t);
	...
	private com.wms.web.entity.order.OrderTotal createTotal(OrderTotal t) {
		com.wms.web.entity.order.OrderTotal totalTotal = new com.wms.web.entity.order.OrderTotal();
