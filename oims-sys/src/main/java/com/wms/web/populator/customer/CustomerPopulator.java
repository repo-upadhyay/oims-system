...
import com.wms.web.entity.customer.attribute.PersistableCustomerAttribute;
	...
	public Customer populate(PersistableCustomer source, Customer target,
		...
		try {
			...
			if(source.getGender()!=null && target.getGender()==null) {
				target.setGender( com.wms.core.business.customer.model.CustomerGender.valueOf( source.getGender() ) );
			}
			if(target.getGender()==null) {
				target.setGender( com.wms.core.business.customer.model.CustomerGender.M);
			}
