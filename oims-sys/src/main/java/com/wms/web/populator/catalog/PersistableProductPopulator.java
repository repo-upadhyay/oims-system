...
import com.wms.web.entity.catalog.product.PersistableImage;
	...
	public Product populate(PersistableProduct source,
		...
		try {
			...
			if(!CollectionUtils.isEmpty(source.getDescriptions())) {
				for(com.wms.web.entity.catalog.product.ProductDescription description : source.getDescriptions()) {
			...
			if(source.getAttributes()!=null) {
				for(com.wms.web.entity.catalog.product.attribute.ProductAttributeEntity attr : source.getAttributes()) {
			...
			if(!CollectionUtils.isEmpty(source.getCategories())) {
				for(com.wms.web.entity.catalog.category.Category categ : source.getCategories()) {
