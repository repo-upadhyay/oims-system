...
public class ShoppingCartDataPopulator extends AbstractDataPopulator<ShoppingCart,ShoppingCartData>
{
    ...
    public ShoppingCartData populate(final ShoppingCart shoppingCart,
        ...
        Set<com.wms.core.business.shoppingcart.model.ShoppingCartItem> items = shoppingCart.getLineItems();
        List<ShoppingCartItem> shoppingCartItemsList=Collections.emptyList();
        try{
            if(items!=null) {
                shoppingCartItemsList=new ArrayList<ShoppingCartItem>();
                for(com.wms.core.business.shoppingcart.model.ShoppingCartItem item : items) {
                    ...
                    Set<com.wms.core.business.shoppingcart.model.ShoppingCartAttributeItem> attributes = item.getAttributes();
                    if(attributes!=null) {
                        List<ShoppingCartAttribute> cartAttributes = new ArrayList<ShoppingCartAttribute>();
                        for(com.wms.core.business.shoppingcart.model.ShoppingCartAttributeItem attribute : attributes) {
            ...
            List<com.wms.core.business.shoppingcart.model.ShoppingCartItem> productsList = new ArrayList<com.wms.core.business.shoppingcart.model.ShoppingCartItem>();
            ...
            if(CollectionUtils.isNotEmpty(orderSummary.getTotals())) {
            	...
            	for(com.wms.core.business.order.model.OrderTotal t : orderSummary.getTotals()) {
