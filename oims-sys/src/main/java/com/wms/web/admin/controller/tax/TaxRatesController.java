package com.wms.web.admin.controller.tax;
...
import com.wms.core.business.tax.model.taxrate.TaxRateDescription;
import com.wms.core.business.tax.service.TaxClassService;
import com.wms.core.business.tax.service.TaxRateService;
...
public class TaxRatesController {
	...
	public String displayTaxRates(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return com.wms.web.admin.controller.ControllerConstants.Tiles.Tax.taxRates;
	}
	...
	public String updateTaxRate(@Valid @ModelAttribute("taxRate") TaxRate taxRate, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
		...
		if (result.hasErrors()) {
			...
			return com.wms.web.admin.controller.ControllerConstants.Tiles.Tax.taxRate;
