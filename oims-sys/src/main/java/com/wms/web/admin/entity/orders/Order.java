package com.wms.web.admin.entity.orders;
...
public class Order implements Serializable {
	...
	private  com.wms.core.business.order.model.Order order;
	...
	public com.wms.core.business.order.model.Order getOrder() {
		return order;
	}

	public void setOrder(com.wms.core.business.order.model.Order order) {
		this.order = order;
	}
