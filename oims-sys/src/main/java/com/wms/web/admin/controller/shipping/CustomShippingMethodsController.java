package com.wms.web.admin.controller.shipping;
...
import com.wms.core.business.shipping.model.ShippingType;
...
public class CustomShippingMethodsController {
	...
	public String saveShippingMethod(@ModelAttribute("configuration") CustomShippingQuotesConfiguration configuration, BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
		...
		environments.add(com.wms.core.constants.Constants.TEST_ENVIRONMENT);
		environments.add(com.wms.core.constants.Constants.PRODUCTION_ENVIRONMENT);
...
/*		List<Country> shippingCountries = new ArrayList<Country>();
		...
		List<String> environments = new ArrayList<String>();
		environments.add(com.wms.core.constants.Constants.PRODUCTION_ENVIRONMENT);//only production
