...
import com.wms.web.admin.controller.customers.CustomerController;
...
public class ManufacturerController {
	...
	private String displayManufacturer(Long manufacturerId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.wms.web.admin.entity.catalog.Manufacturer manufacturer = new com.wms.web.admin.entity.catalog.Manufacturer();		
	...
	public String saveManufacturer( @Valid @ModelAttribute("manufacturer") com.wms.web.admin.entity.catalog.Manufacturer manufacturer, BindingResult result, Model model,  HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
