package com.wms.web.admin.controller.orders;
...
private static final Logger LOGGER = LoggerFactory.getLogger(OrderControler.class);
	...
	private String displayOrder(Long orderId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.wms.web.admin.entity.orders.Order order = new com.wms.web.admin.entity.orders.Order();
	...
	public String saveOrder(@Valid @ModelAttribute("order") com.wms.web.admin.entity.orders.Order entityOrder, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
		...
		com.wms.core.business.order.model.Order newOrder = orderService.getById(entityOrder.getOrder().getId() );
