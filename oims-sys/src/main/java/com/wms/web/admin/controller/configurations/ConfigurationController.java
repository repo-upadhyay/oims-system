package com.wms.web.admin.controller.configurations;
...
import com.wms.web.admin.entity.web.ConfigListWrapper;
...
public class ConfigurationController {
	...
	public String displayAccountsConfguration(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		**/
		...
		return com.wms.web.admin.controller.ControllerConstants.Tiles.Configuration.accounts;
	}
