package com.wms.web.admin.controller.products;
...
import com.wms.core.business.catalog.product.model.price.ProductPriceType;
...
import com.wms.core.utils.ajax.AjaxPageableResponse;
import com.wms.core.utils.ajax.AjaxResponse;
import com.wms.web.admin.controller.ControllerConstants;
import com.wms.web.admin.entity.web.Menu;
...
public class ProductPriceController {
	...
	public String getProductPrices(@RequestParam("id") long productId,Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		for(ProductAvailability availability : product.getAvailabilities()) {
			if(availability.getRegion().equals(com.wms.core.constants.Constants.ALL_REGIONS)) {
	...
	private String displayProductPrice(Product product, Long productPriceId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.wms.web.admin.entity.catalog.ProductPrice pprice = new com.wms.web.admin.entity.catalog.ProductPrice();
		...
		if(productPriceId!=null) {
			...
			//get default availability
			for(ProductAvailability availability : availabilities) {
				if(availability.getRegion().equals(com.wms.core.constants.Constants.ALL_REGIONS)) {//TODO to be updated when multiple regions is implemented
					productAvailability = availability;
	...
	public String saveProductPrice(@Valid @ModelAttribute("price") com.wms.web.admin.entity.catalog.ProductPrice price, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
