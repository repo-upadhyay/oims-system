package com.wms.web.admin.security;
...
public class UserServicesImpl implements WebUserServices{
	...
	public UserDetails loadUserByUsername(String userName)
		...
		com.wms.core.business.user.model.User user = null;
	...
	public void createDefaultAdmin() throws Exception {
		  ...
		  com.wms.core.business.user.model.User user = new com.wms.core.business.user.model.User("admin",password,"admin@oims.com");
