				...
				<br/><br/>
						...
						<form:hidden path="product.id" />
                  		...
                  		<div class="control-group">
	                        ...
	                        <div class="controls">
	                        		 <input id="dateAvailable" name="dateAvailable" value="${product.dateAvailable}" class="small" type="text" data-date-format="<%=com.wms.core.constants.Constants.DEFAULT_DATE_FORMAT%>" data-datepicker="datepicker"> 
	                                 <script type="text/javascript">
