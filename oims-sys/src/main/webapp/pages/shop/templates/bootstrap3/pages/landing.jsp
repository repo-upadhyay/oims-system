            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item animated fadeInUp">
                        <img alt="First slide" src="<c:out value="/oims-sys/resources/templates/bootstrap3/img/slide_1.jpg"/>">
                        <div class="caption">
                    ...
                    <div class="item  animated fadeInUp">
                        <img alt="Second slide" src="<c:out value="/oims-sys/resources/templates/bootstrap3/img/slide_2.jpg"/>">
                        <div class="caption">
                            <div class=" slider-title animated fadeInDown delay1">GET YOUR DECORATION</div>
