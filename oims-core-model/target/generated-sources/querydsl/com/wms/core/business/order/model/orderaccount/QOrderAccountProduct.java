package com.wms.core.business.order.model.orderaccount;
...
public class QOrderAccountProduct extends EntityPathBase<OrderAccountProduct> {
    ...
    private static final long serialVersionUID = 1200663779L;
    ...
    public final com.wms.core.business.order.model.orderproduct.QOrderProduct orderProduct;
    ...
    public QOrderAccountProduct(Class<? extends OrderAccountProduct> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.orderProduct = inits.isInitialized("orderProduct") ? new com.wms.core.business.order.model.orderproduct.QOrderProduct(forProperty("orderProduct"), inits.get("orderProduct")) : null;
    }
