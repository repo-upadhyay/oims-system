...
public class QProductPrice extends EntityPathBase<ProductPrice> {
    ...
    private static final long serialVersionUID = -2103208043L;
    ...
    public final com.wms.core.business.catalog.product.model.availability.QProductAvailability productAvailability;
    ...
    public QProductPrice(Class<? extends ProductPrice> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.productAvailability = inits.isInitialized("productAvailability") ? new com.wms.core.business.catalog.product.model.availability.QProductAvailability(forProperty("productAvailability"), inits.get("productAvailability")) : null;
    }
