package com.wms.core.business.catalog.product.model.relationship;
...
public class QProductRelationship extends EntityPathBase<ProductRelationship> {
    ...
    private static final long serialVersionUID = 1843006151L;
    ...
    public final com.wms.core.business.catalog.product.model.QProduct relatedProduct;

    public final com.wms.core.business.merchant.model.QMerchantStore store;
    ...
    public QProductRelationship(Class<? extends ProductRelationship> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.relatedProduct = inits.isInitialized("relatedProduct") ? new com.wms.core.business.catalog.product.model.QProduct(forProperty("relatedProduct"), inits.get("relatedProduct")) : null;
        this.store = inits.isInitialized("store") ? new com.wms.core.business.merchant.model.QMerchantStore(forProperty("store"), inits.get("store")) : null;
    }
