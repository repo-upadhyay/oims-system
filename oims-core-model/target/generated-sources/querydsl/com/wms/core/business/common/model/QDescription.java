...
public class QDescription extends EntityPathBase<Description> {
    ...
    private static final long serialVersionUID = -281295759L;
    ...
    public QDescription(Class<? extends Description> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.language = inits.isInitialized("language") ? new com.wms.core.business.reference.language.model.QLanguage(forProperty("language"), inits.get("language")) : null;
    }
