...
public class QSystemNotification extends EntityPathBase<SystemNotification> {
    ...
    private static final long serialVersionUID = -1316057375L;
    ...
    public final com.wms.core.business.user.model.QUser user;
    ...
    public QSystemNotification(Class<? extends SystemNotification> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.wms.core.business.user.model.QUser(forProperty("user"), inits.get("user")) : null;
    }
