package com.wms.core.business.catalog.product.model.review;
...
public class QProductReview extends EntityPathBase<ProductReview> {
    ...
    private static final long serialVersionUID = -1672764217L;
    ...
    public final com.wms.core.business.common.model.audit.QAuditSection audit;

    public final com.wms.core.business.customer.model.QCustomer customer;
    ...
    public QProductReview(Class<? extends ProductReview> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.audit = inits.isInitialized("audit") ? new com.wms.core.business.common.model.audit.QAuditSection(forProperty("audit")) : null;
        this.customer = inits.isInitialized("customer") ? new com.wms.core.business.customer.model.QCustomer(forProperty("customer"), inits.get("customer")) : null;
