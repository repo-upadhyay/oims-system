package com.wms.core.business.merchant.model;
...
public class QMerchantStore extends EntityPathBase<MerchantStore> {
    ...
    private static final long serialVersionUID = 951918411L;
    ...
    public final com.wms.core.business.reference.country.model.QCountry country;
    ...
    public final ListPath<com.wms.core.business.reference.language.model.Language, com.wms.core.business.reference.language.model.QLanguage> languages = this.<com.wms.core.business.reference.language.model.Language, com.wms.core.business.reference.language.model.QLanguage>createList("languages", com.wms.core.business.reference.language.model.Language.class, com.wms.core.business.reference.language.model.QLanguage.class, PathInits.DIRECT2);
    ...
    public final com.wms.core.business.reference.zone.model.QZone zone;
    ...
    public QMerchantStore(Class<? extends MerchantStore> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.country = inits.isInitialized("country") ? new com.wms.core.business.reference.country.model.QCountry(forProperty("country"), inits.get("country")) : null;
        ...
        this.zone = inits.isInitialized("zone") ? new com.wms.core.business.reference.zone.model.QZone(forProperty("zone"), inits.get("zone")) : null;
    }
