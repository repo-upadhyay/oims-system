package com.wms.core.business.catalog.product.model.manufacturer;
...
public class QManufacturerDescription extends EntityPathBase<ManufacturerDescription> {
    ...
    private static final long serialVersionUID = 1956659204L;
    ...
    public final com.wms.core.business.common.model.QDescription _super;
    ...
    // inherited
    public final com.wms.core.business.reference.language.model.QLanguage language;
    ...
    public QManufacturerDescription(Class<? extends ManufacturerDescription> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this._super = new com.wms.core.business.common.model.QDescription(type, metadata, inits);
