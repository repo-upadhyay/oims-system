...
public class QOrderAccount extends EntityPathBase<OrderAccount> {
    ...
    private static final long serialVersionUID = -1897535892L;
    ...
    public final com.wms.core.business.order.model.QOrder order;
    ...
    public QOrderAccount(Class<? extends OrderAccount> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.wms.core.business.order.model.QOrder(forProperty("order"), inits.get("order")) : null;
    }
