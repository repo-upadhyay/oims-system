...
public class ProductPriceTestCase extends AbstractSalesManagerCoreTestCase {
	...
	public void testPriceWithCurrency() throws Exception {
		...
		List<com.wms.core.business.reference.currency.model.Currency> currencies = currencyService.list();
		...
		com.wms.core.business.reference.currency.model.Currency c = new com.wms.core.business.reference.currency.model.Currency();
