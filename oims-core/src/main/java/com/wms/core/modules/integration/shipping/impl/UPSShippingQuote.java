...
import com.wms.core.business.system.model.ModuleConfig;
...
import com.wms.core.utils.DataUtils;
...
/*		List<String> services = options.get("services");
	...
	public List<ShippingOption> getShippingQuotes(
		...
		try {
			...
			String xml = "<?xml version=\"1.0\"?><RatingServiceSelectionRequest><Request><TransactionReference><CustomerContext>oims</CustomerContext><XpciVersion>1.0001</XpciVersion></TransactionReference><RequestAction>Rate</RequestAction><RequestOption>Shop</RequestOption></Request>";
			...
			Map serviceMap = com.wms.core.util.ShippingUtil
