...
public class ProductPriceUtils {
	...
	public String getFormatedAmountWithCurrency(Locale locale, com.wms.core.business.reference.currency.model.Currency currency, BigDecimal amount) throws Exception {
		if(amount==null) {
			return "";
		}
	...
	/**
	 * Returns a formatted amount using oims Currency
	 ...
	 * @throws Exception
	 */
	public String getFormatedAmountWithCurrency(com.wms.core.business.reference.currency.model.Currency currency, BigDecimal amount) throws Exception {
		if(amount==null) {
			return "";
		}
