...
public class SearchServiceImpl implements SearchService {
	...
	@Override
	public com.wms.core.business.search.model.SearchResponse search(MerchantStore store, String languageCode, String jsonString, int entriesCount, int startIndex) throws ServiceException {
		...
		try {
			...
			com.wms.core.business.search.model.SearchResponse resp = new com.wms.core.business.search.model.SearchResponse();
